...
class SimulationConfig:
    ...
    rtol: float = 1e-7  # paper value; both reference cases also reproduce at looser tolerances (see docs/reproducibility_scope.md)
    atol: float = 1e-7
...
class FitnessSettings:
    ...
    t_mission_target: float = 25 * 365.25 * 24 * 60 * 60  # 25 Julian years in seconds (matches the shipped configs)
